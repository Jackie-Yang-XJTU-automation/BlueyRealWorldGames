...
const PRESET_NAMES = ['大厨', 'Bingo', 'Bluey', '爸爸', '妈妈']
...
const BBQ_ACTIONS: Array<{
  ...
  { id: 'salad', emoji: '🫑', label: '沙拉', hint: '彩色彩椒', color: '#1C98ED' },
  { id: 'dressing', emoji: '🥗', label: '酱汁', hint: '泥巴口味', color: '#AB47BC' },
        ...
        <div className="relative flex flex-col items-center px-4 pb-4">
          <div className="relative w-full max-w-sm pt-2">
            ...
            <div className="relative mx-auto rounded-[32px] border-4 border-white bg-white/82 p-4 text-center shadow-[0_12px_34px_rgba(44,67,100,0.12)]">
              ...
              <p className="text-[11px] font-black uppercase tracking-widest text-[#5a5a87]/35">BBQ</p>
          ...
          {game.state === 'running' && currentTask && !game.currentEvent && (
            <div className="mb-3 w-full max-w-sm rounded-[24px] border-2 border-white bg-white/88 p-3 text-left shadow-[0_7px_18px_rgba(44,67,100,0.08)]">
              <div className="mb-2 flex items-center justify-between gap-2">
                <span className="rounded-full bg-[#FFF3E0] px-2.5 py-1 text-[10px] font-black uppercase tracking-widest text-[#5a5a87]/55">
                  现在这一步
                </span>
